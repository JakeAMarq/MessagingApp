...
public class AcceptUserViewModel extends AndroidViewModel {
     ...
     * @param application
     */
    public AcceptUserViewModel(@NonNull Application application) {
        super(application);
     ...
     */
    public void accept_contact(final Integer primary_key,
                               final Integer primaryA,
                               final Integer primaryB) {
        String url = getApplication().getResources().getString(R.string.base_url) + "accept_contact";
        JSONObject body = new JSONObject();
        try {
            // all of the data that is being passed to the backend.
            body.put("primaryKey", primary_key);
            body.put("MemberID_A", primaryA);
            body.put("MemberID_B", primaryB);
        } catch (JSONException e) {
            e.printStackTrace();
        }
